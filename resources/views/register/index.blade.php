                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="needs-validation custom-form mt-3 pt-2" action="/signup" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <a href="https://t.me/userinfobot" target="_blank" class="text-primary text-sm d-block text-decoration-underline" style="color: #023669 !important;">
                                        ...
                                        <div class="mb-4">
                                            <div class="form-check">
                                                <input id="terms" type="checkbox" class="form-check-input" style="color: #023669 !important;" required>
