    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <button class="btn btn-primary w-100 mb-2" onclick="openMenuForm('menu')" style="background-color: #023669 !important; border-color: #023669 !important;">Main Menu</button>
            ...
            <form action="/menus/store" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 d-none" id="parentMenuContainer">
                        <label class="form-label d-block">Choose Main Menu (Fill in either the Menu ID or Parent ID)</label>
                    ...
                    <div class="mb-3 d-none" id="iconContainer">
                        ...
                        <small>Use icon from <a href="https://feathericons.com/" target="_blank" style="color: #023669">Feather Icons</a></small>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color: #023669 !important; border-color: #023669 !important;">Create</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="chooseMenuTypeEditModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <p>Please choose type of menu:</p>
                <button class="btn btn-primary w-100 mb-2" onclick="openMenuFormEdit('menu')" style="background-color: #023669 !important; border-color: #023669 !important;">Main Menu</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/menus/update" method="post">
                                ...
                                @foreach ($menu->subMenus as $submenu)
                                    ...
                                    @foreach ($submenu->subSubMenus as $subsubmenu)
                                        <option value="{{ $subsubmenu->id }}"
                                            ...
                                            data-name="{{ $subsubmenu->name }}"
                                            data-route="{{ $subsubmenu->route }}"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary" style="background-color: #023669 !important; border-color: #023669 !important;">Edit</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="deleteMenuForm" action="/menus/delete" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" id="deleteMenuButton" class="btn btn-primary" style="background-color: #023669 !important; border-color: #023669 !important;">Delete</button>
                </div>
            </form>
        </div>
    </div>
